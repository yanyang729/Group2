...
class DataScraper:
    ...
    def __init__(self,size=10000, from_date=1451606400, to_date=1483228800):
        """
        Init the class DataScraper
        :type size: int
        :type from_date: long
        :type to_date: long
        :param size: items of scrape data. Default 100000
        :param from_date: The start of creation date of questions. Type is datetime. timestamp. Default 1451606400
        :param to_date: The end of creation date of questions. Type is datetime. timestamp. Default 1483228800
        """
        self.data_size = size
